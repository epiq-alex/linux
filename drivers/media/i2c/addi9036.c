...
/* Elements of the structure must be ordered ascending by width */
...
static int addi9036_s_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_LINK_FREQ:
		break;
	default:
		dev_dbg(addi9036->dev, "%s > Unhandled: %x  param=%x\n",
...
__addi9036_get_pad_format(struct addi9036 *addi9036,
			  struct v4l2_subdev_pad_config *cfg,
			  unsigned int pad,
			  enum v4l2_subdev_format_whence which)
{
	...
	case V4L2_SUBDEV_FORMAT_ACTIVE:
		return &addi9036->fmt;
	default:
		/* Returning null causes 0 derefence in addi9036_get_format */
		return &addi9036->fmt;
	}
}
			       ...
			       struct v4l2_subdev_format *format)
{
	...
	format->format = *__addi9036_get_pad_format(addi9036, cfg, format->pad,
						    format->which);
...
__addi9036_get_pad_crop(struct addi9036 *addi9036,
			struct v4l2_subdev_pad_config *cfg,
			       ...
			       struct v4l2_subdev_format *format)
{
	...
	crop = __addi9036_get_pad_crop(addi9036, cfg, format->pad,
					 format->which);
	...
	framefmt = __addi9036_get_pad_format(addi9036, cfg, format->pad,
					     format->which);
				  ...
				  struct v4l2_subdev_selection *sel)
{
	...
	sel->r = *__addi9036_get_pad_crop(addi9036, cfg, sel->pad, sel->which);
...
static struct i2c_driver addi9036_i2c_driver = {
	.driver			= {
		.of_match_table = of_match_ptr(addi9036_of_match),
		.name		= "addi9036",
	},
